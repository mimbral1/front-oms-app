...
export function ResumenAuditoria() {
  ...
  > = {
    ...
    "En curso": "warning", // ✅ Amarillo
    Corregir: "warning", // ✅ Amarillo
    Pendiente: "info", // ✅ Azul
    Error: "error", // ✅ Rojo
  };
  const estadoColorMap: Record<string, string> = {
    Finalizada: "bg-green-500 text-white", // ✅ Verde
    "En curso": "bg-yellow-500 text-white", // ✅ Amarillo
    Corregir: "bg-orange-500 text-white", // ✅ Naranja
    Pendiente: "bg-blue-500 text-white", // ✅ Azul
    Error: "bg-red-500 text-white", // ✅ Rojo
  };

  usePageHeader(
    () => ({
      title: `RESUMEN AUDITORIA:  #${auditoria?.id}`,
  ...
  if (id !== auditoria?.id) {
    return (
      <p className="p-4 text-center text-red-500">Auditoria no encontrada</p>
    );
  }
