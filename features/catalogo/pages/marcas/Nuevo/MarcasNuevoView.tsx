...
export default function MarcasNuevoView() {
    const router = useRouter();
    const [record, setRecord] = useState<NewBrand>({ ...initialRecord });

    const handleChange = (field: keyof NewBrand, value: any) =>
    ...
    usePageHeader(
        () => ({
            title: (
                <div>
                    <div className="text-xs font-semibold uppercase tracking-wider text-blue-600">BRAND</div>
