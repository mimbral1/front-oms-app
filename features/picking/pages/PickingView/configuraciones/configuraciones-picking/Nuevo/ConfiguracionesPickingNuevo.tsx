// views\PickingView\configuraciones\configuraciones-picking\Nuevo\Nuevo.tsx
"use client";
...
export function ConfiguracionesCreateView() {
        ...
        const fetchConfig = async () => {
            ...
            try {
                ...
                setConfig({
                    ...
                    desplegar: false,
                    itemsSueltos: false,
                    itemsFaltantes: false,
                    confirmarItemsPos: false,
                    confirmarItemsIgn: false,
                    confirmarItemsDesp: false,
                    confirmarItemsSinCanasto: false,
                    sustitucionOnline: '',
                    sustitucionOffline: '',
                    criteriosSustitucionEstandar: ['', '', ''],
                    criteriosSustitucionCandidatos: ['', '', ''],
                    pickearCantidadMayor: false,
                    tipoIdPedido: '',
                });
            } catch (err) {
